...
public class Shoot : MonoBehaviour
{
    ...
    void fireBullet() {
        ...
        bullet.GetComponent<Bullet>().damage = (int) Random.Range(minDamage * PlayerStats.playerStats.damageMultiplier, maxDamage * PlayerStats.playerStats.damageMultiplier);
    ...
    void fireSpread() {
        ...
        bullet1.GetComponent<Bullet>().damage = (int) Random.Range(minDamage * PlayerStats.playerStats.damageMultiplier, maxDamage * PlayerStats.playerStats.damageMultiplier);
        ...
        bullet2.GetComponent<Bullet>().damage = (int) Random.Range(minDamage * PlayerStats.playerStats.damageMultiplier, maxDamage * PlayerStats.playerStats.damageMultiplier);
        ...
        bullet3.GetComponent<Bullet>().damage = (int) Random.Range(minDamage * PlayerStats.playerStats.damageMultiplier, maxDamage * PlayerStats.playerStats.damageMultiplier);
